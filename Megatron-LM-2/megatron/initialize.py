...
def _initialize_distributed():
    ...
    if device_count > 0:
        if mpu.model_parallel_is_initialized():
            ...
            if args.imbalance_tp_groups:
                tensor_model_parallel_size = [int(x) for x in args.imbalance_tp_groups.split('-')]
                mpu.initialize_custom_model_parallel(tensor_model_parallel_size,
